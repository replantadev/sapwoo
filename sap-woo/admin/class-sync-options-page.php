...
add_action('update_option_sapwc_cron_interval', function ($old, $new) {
    if ($old !== $new) {
        ...
        error_log("[SAPWC Cron Interval] Intervalo actualizado a $new");
    }
}, 10, 2);
